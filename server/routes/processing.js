...
// POST /api/processing-records - Create a new processing record
router.post('/', (req, res) => {
  try {
...
// PUT /api/processing-records/:id - Partial update (blocked if COMPLETED)
...
// DELETE /api/processing-records/:id - Delete record (blocked with 409 if COMPLETED)
...
// PATCH /api/processing-records/:id/start - Move status to IN_PROGRESS
...
// PATCH /api/processing-records/:id/complete - Move status to COMPLETED
...
// PATCH /api/processing-records/:id/status - Generic status update
